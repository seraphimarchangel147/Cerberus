...
(function () {
  ...
  /* ── OMEGA baked sprite layer ──────────────────────────────────────────
     160x160 / 48-color indexed PNG (17 KB data-URI), decoded natively by the
     browser. Replaces ~2000 lines of procedural pxEllipse/pxRect draw calls.
     Body is a nearest-neighbour blit; the procedural fire, ember particles,
     chest-gem flare and scanline aura still draw ON TOP, so it stays alive.
