...
const WIZARD_FIELDS = [
  ...
  // OAuth subscription tokens (provider-oauth.js) + overridable client IDs.
  ...
  "OPENAGI_COMPUTER_NODE",
  "OPENAGI_COMPUTER_NODE_TOKEN",
  "OPENAGI_DESKTOP_LEASE",
  "OPENAGI_DESKTOP_LEASE_TTL_MS",
  "OPENAGI_MUTATION_LEASE_TTL_MS",
  ...
  "OPENAGI_LEDGER_ENRICHMENT",
  "OPENAGI_SELF_OPTIMIZATION",
  "AGENT_ROUTING",
  "OPENAGI_DEV_WARN",
  "OPENAGI_MAX_CHILDREN", "OPENAGI_MAX_SPAWN_DEPTH",
  "OPENAGI_SUBAGENT_MAX_ITERATIONS", "OPENAGI_SUBAGENT_MAX_TURN_SECONDS",
  "OPENAGI_CHAT_MAX_ITERATIONS", "OPENAGI_MAX_ITERATIONS",
  "OPENAGI_MAX_TURN_SECONDS", "OPENAGI_WALL_CLOCK_CHECKPOINTS",
  ...
  "OPENAGI_CURATOR_PRUNE_BUNDLED", "OPENAGI_CURATOR_SCOPE",
  "OPENAGI_SKILL_AUTOCURATE", "OPENAGI_SKILL_AUTO_CONFIDENCE",
  "OPENAGI_SKILL_AUTO_MIN_OCCURRENCES", "OPENAGI_SKILL_AUTO_MAX_PER_DAY",
  "OPENAGI_SKILL_IMPROVE_MIN_USES", "OPENAGI_SKILL_IMPROVE_MAX_PER_RUN",
  "OPENAGI_BACKGROUND_REVIEW",
  "OPENAGI_MEMORY_PROVIDER",
  "OPENAGI_MEMTREE", "OPENAGI_WAKE_BUDGET",
  "OPENAGI_SPILL_BYTES", "OPENAGI_MEMORY_ENTRY_CHARS",
  ...
  "OPENAGI_REASONING_EFFORT",
  "OPENAGI_REPEATED_SUCCESS_LIMIT",
  "OPENAGI_WALL_CLOCK_FREE_EXTENSIONS",
  "OPENAGI_WALL_CLOCK_IDLE_STRIKES",
  "OPENAGI_MAX_TURN_HARD_SECONDS",
  "OPENAGI_ERROR_CLASSIFIER",
  "OPENAGI_TOOL_ERROR_CLASSIFIER",
  "OPENAGI_SYSTEM_MEMORY_SUPPRESSION",
  "OPENAGI_HARNESS_COUNTERS",
  "OPENAGI_CREDENTIAL_POOLS",
  "OPENAGI_RESPONSES_CONTINUATION",
  "OPENAGI_TOOL_SEARCH",
  "OPENAGI_SEMANTIC_BROWSER", "OPENAGI_BROWSER_CDP_URL",
  "OPENAGI_DOMAIN_LEARNINGS",
  "OPENAGI_WEB_QA",
  "OPENAGI_TERMINALS", "OPENAGI_TERMINAL_IMAGE",
  "OPENAGI_APPROVAL_TIMEOUT_MS",
  "OPENAGI_MAX_TOOL_OUTPUT_CHARS", "OPENAGI_CONTEXT_COMPACT_CHARS", "OPENAGI_CONTEXT_KEEP_RECENT_HOPS",
  "OPENAGI_CONTEXT_WINDOW_TOKENS", "OPENAGI_VALUE_AWARE_COMPACTION",
  "OPENAGI_CONTEXT_MILD_RATIO", "OPENAGI_CONTEXT_AGGRESSIVE_RATIO",
  "OPENAGI_CONTEXT_EMERGENCY_RATIO", "OPENAGI_CONTEXT_EMERGENCY_TARGET_RATIO",
