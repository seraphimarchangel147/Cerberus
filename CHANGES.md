...
- 2026-08-09T04:03:42.996Z · **azazel** · edit `test/persistent-goals.test.js` — Regression tests: tail goal evaluation judges watchdog-stopped turns (completes) and fails open on judge error (never pauses)- 2026-08-11T10:14:11.747Z · **azazel** · create `test/stream-truncation-retry.test.js`
